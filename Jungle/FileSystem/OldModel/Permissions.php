...
namespace Jungle\FileSystem\OldModel {
	...
	class Permissions implements IPermissions{
		...
		/**
		 * @param callable $onChanged
		 */
		public function __construct(callable $onChanged = null){
		 ...
		 * @param callable $h
		 */
		public function setOnChanged(callable $h){
			$this->onChanged = h;
		}
		...
		public function setOwnerRead($readable = true){
			if($readable!==$this->hasOwnerRead() && $this->_beforeChanged()!==false){
		...
		public function setOwnerWrite($writable = true){
			if($writable!==$this->hasOwnerWrite() && $this->_beforeChanged()!==false){
		...
		public function setOwnerExecute($executable = true){
			if($executable!==$this->hasOwnerExecute() && $this->_beforeChanged()!==false){
		 ...
		 * @return mixed
		 */
		public function setPermissions($permissions, $merge = false, $mutable = false){
