...
namespace Jungle\Util\Specifications\TextTransfer {
	...
	use Jungle\Util\Specifications\TextTransfer\Header\Pool;
	...
	class Document{
		...
		/** @var \Jungle\Util\ObjectStorage|Header[] */
		protected $headers = [];
		...
		/**
		 * @param BodyInterface|string $body
		 * @return $this
		 */
		public function setBody($body=null){
			...
			if($old!==$body){
				$this->body = $body;
				if($old instanceof BodyInterface){
