...
namespace Jungle\Util\Data\Schema\OuterInteraction {
	...
	use Jungle\Util\Data\Schema\OuterInteraction\ValueAccessor\Getter;
	use Jungle\Util\Data\Schema\OuterInteraction\ValueAccessor\GetterInterface;
	use Jungle\Util\Data\Schema\OuterInteraction\ValueAccessor\Setter;
	use Jungle\Util\Data\Schema\OuterInteraction\ValueAccessor\SetterInterface;

	/**
	 * Class ValueAccessor
	 * @package Jungle\Util\Data\Schema\OuterInteraction
	 */
	class ValueAccessor{
		 ...
		 * @param string $key
		 * @param mixed $value
		 * @return \Jungle\Util\Data\Record\PropertyRegistryInterface|mixed
		 */
