...
namespace Jungle\Util\Communication {
	...
	use Jungle\Util\Communication\Stream\Builder;
	use Jungle\Util\Communication\Stream\Command;
	use Jungle\Util\Communication\Stream\Connection;
	use Jungle\Util\Communication\Stream\Exception;
	use Jungle\Util\Communication\Stream\Specification;
	...
	class Stream{
		...
		/**
		 * @param \Jungle\Util\Communication\Stream\Specification $specification
		 * @return $this
		 */
