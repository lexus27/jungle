...
namespace Jungle\Communication\Stream {
	...
	use Jungle\Communication\Stream\Command\Rule;
	...
	class Command{
		...
		/** @var \Jungle\Communication\Stream\Specification\\Jungle\Communication\Stream\Command\Rule[] */
		protected $rules = [];
		...
		/**
		 * @param \Jungle\Communication\Stream\Command\Rule $rule
		 * @return $this
		 */
		...
		/**
		 * @param \Jungle\Communication\Stream\Specification\\Jungle\Communication\Stream\Command\Rule $rule
		 * @return $this
		 */
