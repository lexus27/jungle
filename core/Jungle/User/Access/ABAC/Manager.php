...
namespace Jungle\User\Access\ABAC {
	...
	use Jungle\User\Access\ABAC\Adapter\ContextAdapter;
	use Jungle\User\Access\ABAC\Adapter\PolicyAdapter;
	use Jungle\User\Access\ABAC\Context\ObjectAccessor;
	use Jungle\User\Access\ABAC\Policy;
	use Jungle\User\Access\ABAC\Policy\Combiner;
	use Jungle\User\Access\ABAC\Policy\ConditionResolver;
	use Jungle\User\Access\ABAC\Policy\ExpressionResolver;
	use Jungle\User\Access\ABAC\Policy\MatchResult;
